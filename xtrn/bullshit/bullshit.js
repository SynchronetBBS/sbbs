...
(function() {
  ...
  (function() {
    ...
    var WindowManager = /* @__PURE__ */ function(_BaseWindow) {
      ...
      return _createClass(WindowManager2, [{
        ...
        value: function removeWindow(window2) {
          ...
          return this.closeWindow(window2);
        }
      }, {
        key: "resizeWindow",
              ...
              if ((y >= newEndStop.y || x >= newEndStop.x) && this._windowMap[y][x] === window2.id) {
                ...
                for (var z = wz - 1; z >= 0; z--) {
                  ...
                  this.setData(stackWindow, {
                    x: x,
                    y: y
                  }, (_swb = swb[y - window2.position.y]) === null || _swb === void 0 ? void 0 : _swb[x - window2.position.x]);
                  break;
                }
      ...
      return _createClass(Window2, [{
        ...
        value: function _setData(position, data) {
          ...
          if (cell === void 0 || cell["char"] !== data["char"] || cell.attr !== data.attr) {
            ...
            if (offsetPosition.x < this._endStop.x && offsetPosition.y < this._endStop.y) {
      ...
      return _createClass(ControlledWindow2, [{
        ...
        set: function set(title) {
          ...
          if (this._title.alignment === void 0 || this._title.alignment === 0) {
            ...
            xpos = Math.floor((maxLen - text.length) / 2) + 1;
          } else {
            xpos = this._size.width - 3 - text.length;
          }
          this._setData({
            x: xpos,
            y: 0
          ...
          this._setData({
            x: xpos + text.length + 1,
            y: 0
          }, {
            "char": line.RIGHT_T,
            attr: this._buffer[0][xpos + text.length + 1].attr
          });
          this._cursor = {
            x: xpos + 1,
            y: 0
        ...
        set: function set(footer) {
          ...
          this._setData({
            ...
            "char": line.RIGHT_T,
            attr: this._buffer[ly][xpos + text.length + 1].attr
          });
          this._cursor = {
            x: xpos + 1,
            y: ly
      ...
      return _createClass(LightBar2, [{
        ...
        value: function draw() {
          ...
          for (var y = 0; y < this._items.length; y++) {
            attr = y === this._index ? this._colors.highlight : this._colors.normal;
            text = js.global.format(fmt, this._items[y].text);
            this._window.cursor = {
              x: 0,
              y: y
            };
        ...
        value: function update(n) {
          ...
          this._window.write(js.global.format(fmt, this._items[this._index].text), this._colors.normal);
          this._index = ni;
          this._window.cursor = {
            x: 0,
            y: this._index
          };
          this._window.write(js.global.format(fmt, this._items[this._index].text), this._colors.highlight);
          this._window.contentWindow.attr = this._colors.normal;
          ...
          if (this._items[this._index].onHighlight !== void 0) {
            var _this$_items$this$_in, _this$_items$this$_in2;
            (_this$_items$this$_in = (_this$_items$this$_in2 = this._items[this._index]).onHighlight) === null || _this$_items$this$_in === void 0 || _this$_items$this$_in.call(_this$_items$this$_in2, this._items[this._index]);
          }
        }
      }, {
        key: "getCmd",
        value: function getCmd(s) {
          if (js.global.time() - this._lastcmd > 1)
            this._cmdstr = "";
          this._lastcmd = js.global.time();
          switch (s) {
            case keydefs.KEY_UP:
              this._cmdstr = "";
              this.update(-1);
            ...
            case "\r":
              this._cmdstr = "";
              this._items[this._index].onSelect(this._items[this._index]);
              break;
            case "\b":
    ...
    var _js$global3 = js.global, file_exists = _js$global3.file_exists, file_rename = _js$global3.file_rename, system = _js$global3.system, File = _js$global3.File;
    function parseColorOption(color) {
      var c = color.split("|");
      var ret = cgadefs5[c[0]];
      if (c.length > 1)
        ret |= cgadefs5[c[1]];
      if ((ret & 7 << 4) === 0)
        ret |= cgadefs5.BG_BLACK;
      return ret;
    }
    function migrate() {
      var _oldRoot$messageBase, _oldRoot$maxMessages, _oldColors$title, _oldColors$text, _oldColors$lightbarFo, _oldColors$lightbarBa, _oldColors$border;
      var oldFile = "".concat(js.exec_dir, "bullshit.ini");
      if (!file_exists(oldFile))
        return;
      var f = new File(oldFile);
      if (!f.open("r"))
        return;
      var oldRoot = f.iniGetObject();
      var oldColors = f.iniGetObject("colors");
      var oldFiles = f.iniGetObject("files");
      f.close();
      var opts = {
        bullshit: {
          messageBase: (_oldRoot$messageBase = oldRoot === null || oldRoot === void 0 ? void 0 : oldRoot.messageBase) !== null && _oldRoot$messageBase !== void 0 ? _oldRoot$messageBase : "",
          maxMessages: (_oldRoot$maxMessages = oldRoot === null || oldRoot === void 0 ? void 0 : oldRoot.maxMessages) !== null && _oldRoot$maxMessages !== void 0 ? _oldRoot$maxMessages : 100,
          newOnly: (oldRoot === null || oldRoot === void 0 ? void 0 : oldRoot.newOnly) === void 0 ? false : true,
          title: "Bulletins"
        },
        colors: {
          title: (_oldColors$title = oldColors === null || oldColors === void 0 ? void 0 : oldColors.title) !== null && _oldColors$title !== void 0 ? _oldColors$title : "WHITE",
          text: (_oldColors$text = oldColors === null || oldColors === void 0 ? void 0 : oldColors.text) !== null && _oldColors$text !== void 0 ? _oldColors$text : "LIGHTGRAY",
          lightBar: "".concat((_oldColors$lightbarFo = oldColors === null || oldColors === void 0 ? void 0 : oldColors.lightbarForeground) !== null && _oldColors$lightbarFo !== void 0 ? _oldColors$lightbarFo : "WHITE", "|").concat((_oldColors$lightbarBa = oldColors === null || oldColors === void 0 ? void 0 : oldColors.lightbarBackground) !== null && _oldColors$lightbarBa !== void 0 ? _oldColors$lightbarBa : "BG_CYAN"),
          border: (_oldColors$border = oldColors === null || oldColors === void 0 ? void 0 : oldColors.border) !== null && _oldColors$border !== void 0 ? _oldColors$border : "WHITE,LIGHTCYAN,CYAN,LIGHTBLUE"
        },
        files: oldFiles !== null && oldFiles !== void 0 ? oldFiles : {}
      };
      f = new File("".concat(system.ctrl_dir, "modopts.d/bullshit.ini"));
      ...
      f.close();
      file_rename(oldFile, "".concat(oldFile, ".old"));
    }
    function getOptions() {
      var ret = {
        bullshit: {
        ...
        colors: {
          title: cgadefs5.BG_BLACK | cgadefs5.WHITE,
          text: cgadefs5.BG_BLACK | cgadefs5.LIGHTGRAY,
          heading: cgadefs5.BG_BLACK | cgadefs5.DARKGRAY,
          lightBar: cgadefs5.BG_CYAN | cgadefs5.WHITE,
          list: cgadefs5.BG_BLACK | cgadefs5.LIGHTGRAY,
          border: [cgadefs5.BG_BLACK | cgadefs5.WHITE, cgadefs5.BG_BLACK | cgadefs5.LIGHTCYAN, cgadefs5.BG_BLACK | cgadefs5.CYAN, cgadefs5.BG_BLACK | cgadefs5.LIGHTBLUE]
        },
        files: {}
      };
      var f = new File("".concat(system.ctrl_dir, "modopts.d/bullshit.ini"));
      if (!f.open("r"))
        throw new Error("Failed to open ".concat(f.name, " for reading"));
      var bullshitIni = f.iniGetObject("bullshit");
      var colorsIni = f.iniGetObject("bullshit:colors");
      var filesIni = f.iniGetObject("bullshit:files");
      f.close();
      if (typeof (bullshitIni === null || bullshitIni === void 0 ? void 0 : bullshitIni.messageBase) === "string")
        ret.bullshit.messageBase = bullshitIni.messageBase;
      if (typeof (bullshitIni === null || bullshitIni === void 0 ? void 0 : bullshitIni.maxMessages) === "number")
        ret.bullshit.maxMessages = bullshitIni.maxMessages;
      if (ret.bullshit.maxMessages < 1)
        ret.bullshit.maxMessages = Infinity;
      if (typeof (bullshitIni === null || bullshitIni === void 0 ? void 0 : bullshitIni.newOnly) === "boolean")
        ret.bullshit.newOnly = bullshitIni.newOnly;
      if (typeof (bullshitIni === null || bullshitIni === void 0 ? void 0 : bullshitIni.title) === "string")
        ret.bullshit.title = bullshitIni.title;
      if (typeof (colorsIni === null || colorsIni === void 0 ? void 0 : colorsIni.title) === "string")
        ret.colors.title = parseColorOption(colorsIni.title);
      if (typeof (colorsIni === null || colorsIni === void 0 ? void 0 : colorsIni.text) === "string")
        ret.colors.title = parseColorOption(colorsIni.text);
      if (typeof (colorsIni === null || colorsIni === void 0 ? void 0 : colorsIni.heading) === "string")
        ret.colors.title = parseColorOption(colorsIni.heading);
      if (typeof (colorsIni === null || colorsIni === void 0 ? void 0 : colorsIni.lightBar) === "string")
        ret.colors.title = parseColorOption(colorsIni.lightBar);
      if (typeof (colorsIni === null || colorsIni === void 0 ? void 0 : colorsIni.list) === "string")
        ret.colors.title = parseColorOption(colorsIni.list);
      if (typeof (colorsIni === null || colorsIni === void 0 ? void 0 : colorsIni.border) === "string" && colorsIni.border.length > 0) {
        ret.colors.border = [];
        var border = colorsIni.border.split(",");
        var _iterator9 = _createForOfIteratorHelper(border), _step9;
        try {
      ...
      for (var file in filesIni) {
        ret.files[file] = filesIni[file];
      }
      return ret;
    }
    function getWindowOptions(windowManager, border, title, footer) {
      return {
        border: {
        ...
        footer: {
          text: footer !== null && footer !== void 0 ? footer : "",
          attr: cgadefs5.BG_BLACK | cgadefs5.WHITE,
    ...
    function formatItem(text, date, width) {
      return format("%-".concat(width - 17, "s%s"), text.substring(0, width - 18), formatDate(date));
    }
    function getUserHistory() {
      ...
      if (!file_exists2(historyFile))
        return ret;
      var f = new File2(historyFile);
      if (!f.open("r"))
        return ret;
    ...
    function setUserHistory(history) {
      var f = new File2(historyFile);
      if (!f.open("w"))
        return;
    ...
    function getList(options, windowManager, itemHandler) {
      var width = windowManager.size.width - 3;
      var sortables = [];
        ...
        var sortable = {
          item: {
            ...
            onSelect: function onSelect() {
              var f = new File2(options.files[file2]);
              if (!f.open("rb"))
                return;
              var body = f.read();
              f.close();
              itemHandler("".concat(title, " (").concat(formatDate(date), ")"), body, false);
              var history2 = getUserHistory();
              history2.files[file2] = time();
              setUserHistory(history2);
            }
          },
          date: file_date(options.files[file2])
        };
      ...
      if (msgBase.open()) {
        var messages = [];
        var _loop2 = function _loop22(n2) {
          ...
          var sortable = {
            item: {
              ...
              onSelect: function onSelect() {
                if (!msgBase.open())
                  return;
                var body = msgBase.get_msg_body(false, n2);
                if (body === null)
                  return;
                itemHandler("".concat(h.subject, " (").concat(formatDate(h.when_written_time), ")"), body, true);
                var history2 = getUserHistory();
                if (!history2.messages.includes(n2)) {
                  history2.messages.push(n2);
                  setUserHistory(history2);
                }
              }
            },
        ...
        for (var n = msgBase.first_msg; n <= msgBase.last_msg; n++) {
          _ret2 = _loop2(n);
          if (_ret2 === 0)
            continue;
        }
        msgBase.close();
        if (messages.length > options.bullshit.maxMessages)
          messages = messages.splice(-options.bullshit.maxMessages);
        sortables.push.apply(sortables, _toConsumableArray(messages));
      }
      return sortables.sort(function(a, b) {
    ...
    var UI = /* @__PURE__ */ function() {
      function UI2(windowManager, options) {
        _classCallCheck(this, UI2);
        _defineProperty(this, "options", void 0);
        _defineProperty(this, "windowManager", void 0);
        _defineProperty(this, "listWindow", void 0);
        _defineProperty(this, "listMenu", void 0);
        _defineProperty(this, "itemWindow", void 0);
        _defineProperty(this, "activeWindow", "list");
        _defineProperty(this, "noNewItems", false);
        this.options = options;
        this.windowManager = windowManager;
        var listWindowOptions = getWindowOptions(windowManager, options.colors.border, options.bullshit.title, "Q to quit");
        this.listWindow = new ControlledWindow(listWindowOptions);
        var items = getList(options, windowManager, this.itemHandler.bind(this));
        if (items.length < 1) {
          items.push({
            text: "No new bulletins",
            onSelect: function onSelect() {
            }
          });
          this.noNewItems = true;
        }
        this.listMenu = new LightBar({
          items: items,
      ...
      return _createClass(UI2, [{
        key: "itemHandler",
        value: function itemHandler(title, body, wrap) {
          var itemWindowOptions = getWindowOptions(this.windowManager, this.options.colors.border, title, "Q to quit");
          itemWindowOptions.attr = this.options.colors.text;
          this.itemWindow = new ControlledWindow(itemWindowOptions);
          if (wrap) {
            this.itemWindow.wrap = defs_exports.WRAP.WORD;
            this.itemWindow.write(js.global.lfexpand(body));
          } else {
            this.itemWindow.wrap = defs_exports.WRAP.NONE;
            this.itemWindow.contentWindow.writeAnsi(body, 80);
          }
          this.itemWindow.scrollTo({
            x: 0,
            y: 0
          });
        ...
        value: function getCmd(cmd) {
          var _this$itemWindow;
          if (this.activeWindow === "list") {
            if (cmd === "q")
              return false;
            this.listMenu.getCmd(cmd);
          } else if (this.itemWindow !== void 0) {
            switch (cmd) {
              case "q":
                (_this$itemWindow = this.itemWindow) === null || _this$itemWindow === void 0 || _this$itemWindow.close();
                this.activeWindow = "list";
                break;
              case keydefs3.KEY_UP:
                this.itemWindow.scroll(0, -1);
                break;
              case keydefs3.KEY_PAGEUP:
                this.itemWindow.scroll(0, -this.itemWindow.contentWindow.size.height);
                break;
              case keydefs3.KEY_HOME:
                this.itemWindow.scrollTo({
                  x: 0,
                  y: 0
                });
                break;
              case keydefs3.KEY_DOWN:
                this.itemWindow.scroll(0, 1);
                break;
              case keydefs3.KEY_PAGEDN:
                this.itemWindow.scroll(0, this.itemWindow.contentWindow.size.height);
                break;
              case keydefs3.KEY_END:
                this.itemWindow.scrollTo({
                  x: 0,
                  y: this.itemWindow.contentWindow.dataHeight - this.itemWindow.contentWindow.size.height
                });
                break;
              default:
                break;
    ...
    function main() {
      ...
      while (!js.terminated) {
        ...
        var input = console4.getkey().toLowerCase();
        if (!ui.getCmd(input))
          break;
      }
    }
