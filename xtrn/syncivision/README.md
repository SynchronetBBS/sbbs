...
- **`[lobby] enter_sound`** — a one-shot sound played when a player enters the
  ...
  random. Nothing ships: unlike SyncDuke, where you can pull a quip out of your
  own GRP, a cartridge has nothing to extract — a console's audio is generated by
