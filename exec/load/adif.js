var ADIF_specification = {
	regexes:{
		'Maidenhead':/^[A-R]{2}[0-9]{2}(?:[A-X]{2}(?:[0-9]{2})?)?$/
	},
	enumerations:{
		'AntPath':{'values':[
	...
	fields : {
		...
		'ANT_PATH':	{'type':'E', 'desc':"the signal path"},
		'ARRL_SECT':	{'type':'E', 'desc':"the contacted station's ARRL section"},
		...
		'BAND':	{'type':'E', 'desc':"QSO Band"},
		'BAND_RX':	{'type':'E', 'desc':"in a split frequency QSO, the logging station's receiving band"},
		...
		'CLUBLOG_QSO_UPLOAD_STATUS':	{'type':'E', 'desc':"the upload status of the QSO on the Club Log online service"},
		...
		'CONT':	{'type':'E', 'desc':"the contacted station's Continent"},
		'CONTACTED_OP':	{'type':'S', 'desc':"the callsign of the individual operating the contacted station"},
		'CONTEST_ID':	{'type':'S', 'desc':"QSO Contest Identifier use enumeration values for interoperability"},
		...
		'CREDIT_SUBMITTED':	{'type':'C', 'desc':"the list of credits sought for this QSO"},
		'CREDIT_GRANTED':	{'type':'C', 'desc':"the list of credits granted to this QSO"},
		...
		'DXCC':	{'type':'E', 'desc':"the contacted station's Country Code"},
		...
		'EQSL_QSL_RCVD':	{'type':'E', 'desc':"eQSL.cc QSL received status instead of V (deprecated) use <CREDIT_GRANTED:39>DXCC:eqsl,DXCC_BAND:eqsl,DXCC_MODE:eqsl Default Value: N"},
		'EQSL_QSL_SENT':	{'type':'E', 'desc':"eQSL.cc QSL sent status Default Value: N"},
		...
		'GRIDSQUARE':	{'desc':"the contacted station's 2-character, 4-character, 6-character, or 8-character Maidenhead Grid Square"},
		...
		'HRDLOG_QSO_UPLOAD_STATUS':	{'type':'E', 'desc':"the upload status of the QSO on the HRDLog.net online service"},
		...
		'LOTW_QSL_RCVD':	{'type':'E', 'desc':"ARRL Logbook of the World QSL received status instead of V (deprecated) use <CREDIT_GRANTED:39>DXCC:lotw,DXCC_BAND:lotw,DXCC_MODE:lotw Default Value: N"},
		'LOTW_QSL_SENT':	{'type':'E', 'desc':"ARRL Logbook of the World QSL sent status Default Value: N"},
		'MAX_BURSTS':	{'type':'N', 'desc':"maximum length of meteor scatter bursts heard by the logging station, in seconds"},
		'MODE':	{'type':'E', 'desc':"QSO Mode"},
		...
		'MY_DXCC':	{'type':'E', 'desc':"the logging station's Country Code"},
		...
		'MY_GRIDSQUARE':	{'desc':"the logging station's 2-character, 4-character, 6-character, or 8-character Maidenhead Grid Square"},
		...
		'PROP_MODE':	{'type':'E', 'desc':"QSO propagation mode"},
		...
		'QRZCOM_QSO_UPLOAD_STATUS':	{'type':'E', 'desc':"the upload status of the QSO on the QRZ.COM online service"},
		...
		'QSL_RCVD':	{'type':'E', 'desc':"QSL received status instead of V (deprecated) use <CREDIT_GRANTED:39>DXCC:card,DXCC_BAND:card,DXCC_MODE:card Default Value: N"},
		'QSL_RCVD_VIA':	{'type':'E', 'desc':"means by which the QSL was received by the logging station use of M (manager) is deprecated"},
		'QSL_SENT':	{'type':'E', 'desc':"QSL sent status Default Value: N"},
		'QSL_SENT_VIA':	{'type':'E', 'desc':"means by which the QSL was sent by the logging station use of M (manager) is deprecated"},
		'QSL_VIA':	{'type':'S', 'desc':"the contacted station's QSL route"},
		'QSO_COMPLETE':	{'type':'E', 'desc':"indicates whether the QSO was complete from the perspective of the logging station Y - yes N - no NIL - not heard ? - uncertain"},
...
ADIF_specification.fields.ARRL_SECT.enumeration=ADIF_specification.enumerations.ARRLSect;
...
ADIF_specification.fields.GRIDSQUARE.regex=ADIF_specification.regexes.Maidenhead;
ADIF_specification.fields.MY_GRIDSQUARE.regex=ADIF_specification.regexes.Maidenhead;
