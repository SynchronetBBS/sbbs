...
var time_code = user.security.exemptions & UEXEMPT_TIME_ONLINE ? "@TUSED@" : "@TLEFT@";
var time_prefix = user.security.exemptions & UEXEMPT_TIME_ONLINE ? gettext("Used") : gettext("Left");
