...
#define JS_PREF_CLASS_FIELDS \
  ...
  static bool extra_gc_poisoning_;\
...
#define JS_PREF_CLASS_FIELDS_INIT \
  ...
  bool JS::Prefs::extra_gc_poisoning_{true};\
...
#define FOR_EACH_JS_PREF(MACRO) \
  ...
  MACRO("extra_gc_poisoning", extra_gc_poisoning, bool, setAtStartup_extra_gc_poisoning, true)\
...
#define SET_JS_PREFS_FROM_BROWSER_PREFS \
  ...
  JS::Prefs::setAtStartup_extra_gc_poisoning(mozilla::StaticPrefs::javascript_options_extra_gc_poisoning());\
