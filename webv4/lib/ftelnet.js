...
require('ftelnethelper.js', 'GetWebSocketServicePort');
...
var ftelnet = {
    getSplash: get_splash,
    getVariant: get_variant,
    getURL: get_url,
    getRloginPort: GetRLoginPort,
    getWSPort: GetWebSocketServicePort,
    getWSSPort: function () {
        return GetWebSocketServicePort(true);
    },
};
ftelnet;