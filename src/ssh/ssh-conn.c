...
{
	if (pty == NULL || (data == NULL && data_len > 0))
...
{
	if (sess == NULL || inc == NULL || cbs == NULL)
		return NULL;
	dssh_channel ch = calloc(1, sizeof(*ch));
