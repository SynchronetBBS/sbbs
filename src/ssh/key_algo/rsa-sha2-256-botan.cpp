/*
 * key_algo/rsa-sha2-256-botan.cpp -- RSA-SHA2-256 host key algorithm via Botan3 native C++ API.
 *
 * The dssh_register_rsa_sha2_256() function lives in the companion .c file
