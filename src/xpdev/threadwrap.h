...
#define protected_uint64_set(pval, val) std::atomic_store<uint64_t>(pval, val)
...
#define protected_int32_set(pval, val) atomic_store(pval, val)
#define protected_uint32_set(pval, val) atomic_store(pval, val)
#define protected_int64_set(pval, val) atomic_store(pval, val)
#define protected_uint64_set(pval, val) atomic_store(pval, val)
