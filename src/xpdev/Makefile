...
$(MIXERTEST): $(XPDEV-MT_LIB_BUILD) $(MTOBJODIR)$(DIRSEP)mixertest$(OFILE) $(EXEODIR)
	@echo Linking $<
	$(QUIET)$(CC) $(LDFLAGS) $(MT_LDFLAGS) $(XPDEV-MT_CFLAGS) $(XPDEV-MT_LDFLAGS) -e$@ $(MTOBJODIR)$(DIRSEP)mixertest$(OFILE) $(XPDEV-MT_LIBS)
