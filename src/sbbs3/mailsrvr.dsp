...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "..\..\include\mozilla\js" /I "..\xpdev" /I "..\smblib" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "MAILSRVR_EXPORTS" /D "SMB_IMPORTS" /D "MD5_IMPORTS" /D "JAVASCRIPT" /YX /FD /c
...
# ADD LINK32 wsock32.lib winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib msvc.win32.dll.debug/sbbs.lib ../../lib/mozilla/js/win32.debug/js32.lib /nologo /dll /map /machine:I386
