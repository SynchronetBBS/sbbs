...
DLLEXPORT char* tm_as_hhmm(scfg_t*, struct tm*, char* buf);
DLLEXPORT char* time_as_hhmm(scfg_t*, time_t, char* buf);
DLLEXPORT char* tm_as_hhmmss(scfg_t*, struct tm*, char* str, size_t);
