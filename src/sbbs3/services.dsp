...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "..\mozilla\js\src" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "SERVICES_EXPORTS" /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib wsock32.lib winmm.lib ../mozilla/js/src/release/js32.lib /nologo /dll /machine:I386
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\mozilla\js\src" /I "..\mozilla\nsprpub\include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "SERVICES_EXPORTS" /FR /YX /FD /GZ /c
...
# ADD LINK32 msvc.win32.dll.debug/sbbs.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib wsock32.lib winmm.lib ../mozilla/js/src/release/js32.lib /nologo /dll /map /debug /debugtype:both /machine:I386 /pdbtype:sept
