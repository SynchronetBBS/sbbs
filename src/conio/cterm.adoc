...
Defaults: `Pn` = 1 +
Move the cursor to the `Pn`-th next line tab stop.
...
Modes 1, 15, and 17 returning Pm=4 (permanently reset) indicates
support for ECMA-48 selected area transmission (SSA/STS).
Any unrecognized mode returns Pm=0.
