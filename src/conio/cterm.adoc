...
In BEEB mode, ESC is followed by a character interpreted as a serial
attribute code, the same as Prestel.

Additionally, two multi-byte sequences are supported:
