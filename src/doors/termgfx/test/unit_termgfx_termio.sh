...
# termgfx_termio.c reads termgfx_test.ini via xpdev's ini_file.h (sixel_max override --
...
cc -o /tmp/test_termgfx_termio $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio.c" "$TERMGFX/termgfx_termio.c" \
...
cc -o /tmp/test_termgfx_termio_mouse $JXL_DEFINE -DTERMGFX_TEST -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_mouse.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
...
cc -o /tmp/test_termgfx_termio_input $JXL_DEFINE -DTERMGFX_TEST -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_input.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
...
cc -o /tmp/test_termgfx_termio_input_evdev $JXL_DEFINE -DTERMGFX_TEST -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_input_evdev.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
...
cc -o /tmp/test_termgfx_termio_nogfx $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_nogfx.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
...
cc -o /tmp/test_termgfx_termio_canvas $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_canvas.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
...
cc -o /tmp/test_termgfx_termio_present_pending $JXL_DEFINE -DTERMGFX_TEST -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_present_pending.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
...
cc -o /tmp/test_termgfx_termio_gfxmax $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_gfxmax.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
...
cc -o /tmp/test_termgfx_termio_xterm_ceiling $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_xterm_ceiling.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
...
cc -o /tmp/test_termgfx_termio_bottom_dirty $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_bottom_dirty.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
...
cc -o /tmp/test_termgfx_termio_audio $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_audio.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
...
cc -o /tmp/test_termgfx_termio_audio_tone $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_audio_tone.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
...
# same reason.
cc -o /tmp/test_termgfx_termio_audio_underrun $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_audio_underrun.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
...
cc -o /tmp/test_termgfx_termio_audio_backlog $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_audio_backlog.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
...
cc -o /tmp/test_termgfx_termio_audio_static $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_audio_static.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
/tmp/test_termgfx_termio_audio_static

# Sysop "sixel_max" ini override beats even a reported XTSMGRAPHICS ceiling.
# Needs a termgfx_test.ini in CWD when termgfx_termio_init() runs, so this one is
# invoked from a dedicated temp directory rather than $HERE/$DOOR.
cc -o /tmp/test_termgfx_termio_sixelmax_override $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_sixelmax_override.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
...
printf 'sixel_max = 800\n' > "$SIXELMAX_TMPDIR/termgfx_test.ini"
...
# termgfx_test.ini (a per-mixer-tick SMB open/close storm on this door's usual
# CIFS-mounted startup_dir). -Wl,--wrap=fopen redirects every fopen() call in
# termgfx_termio.c to the test's __wrap_fopen(), which counts the termgfx_test.ini opens
...
cc -o /tmp/test_termgfx_termio_audio_ini_off $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   -Wl,--wrap=fopen \
   "$HERE/test_termgfx_termio_audio_ini_off.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
printf '[audio]\nenabled = false\n' > "$INI_TMPDIR/termgfx_test.ini"
...
cc -o /tmp/test_termgfx_termio_audio_ini_tune $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_audio_ini_tune.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
printf '[audio]\nchunk_ms = 50\n' > "$TUNE_TMPDIR/termgfx_test.ini"
...
cc -o /tmp/test_termgfx_termio_audio_ini_headroom $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_audio_ini_headroom.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
printf '[audio]\nheadroom = 50\n' > "$HEADROOM_TMPDIR/termgfx_test.ini"
...
cc -o /tmp/test_termgfx_termio_datadir $JXL_DEFINE -I"$TERMGFX" $XPDEV_INC \
   "$HERE/test_termgfx_termio_datadir.c" "$TERMGFX/termgfx_termio.c" \
   "$LIBS/termgfx/libtermgfx.a" "$LIBS/libxpdev_static.a" \
   -lpthread -lm $JXL_LIBS $SNDFILE_LIBS
