/* termgfx_quant.h -- deterministic RGB888 -> 256-color median-cut quantizer
...
#ifndef TERMGFX_QUANT_H_
#define TERMGFX_QUANT_H_
...
int termgfx_quant_rgb(const uint8_t *rgb, int w, int h,
