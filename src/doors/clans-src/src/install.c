...
void output_bit(FILE *output, int bit)
{
	output_bit_buffer <<= 1;
...
void output_code(FILE *output, int code, int bits)
{
	int i;
...
int input_code(FILE *input, int bits)
{
	int i, bit = 1, code = 0;
...
void compress(FILE *output, int code)
{
	int a, sp = 0;
	int stack[50];
