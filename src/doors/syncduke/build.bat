@echo off
rem ===========================================================================
rem build.bat - Configure and build the Win32 / MSVC (Release) build of SyncDuke.
rem
...
rem build-msvc\Release\syncduke.exe.  Run `jsexec deploy.js` afterwards when you actually
