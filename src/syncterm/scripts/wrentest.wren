...
import "ui_date_picker_test" for UiDatePickerTest
...
class WrenTest {
  ...
  static testConnProtocolLog_() {
    var log = Conn.protocolLog
    check_(log == null || log is String,
        "Conn.protocolLog is null or a String snapshot")
  }
