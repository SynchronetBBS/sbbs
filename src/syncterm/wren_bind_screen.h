...
void fn_Cells_count(WrenVM *vm);
void fn_Cells_iterate(WrenVM *vm);
void fn_Cells_iteratorValue(WrenVM *vm);
void fn_Cells_subscript(WrenVM *vm);
void fn_Cells_toString(WrenVM *vm);
...
void wren_cells_allocate(WrenVM *vm);
void wren_cells_finalize(void *data);
