...
bool menu_settings_select_theme(const char *filename, char *error,
    size_t error_size);
bool menu_settings_select_theme_package(const char *package, char *error,
    size_t error_size);
bool menu_settings_delete_theme(const char *filename, char *error,
    size_t error_size);
bool menu_settings_delete_theme_package(const char *package, char *error,
    size_t error_size);
