...
term_gotoxy(int x, int y)
{
	...
	cterm_write(cterm, ansistr, strlen(ansistr), NULL);
}

static void
term_clearscreen(void)
{
	cterm_write(cterm, "\x1b[0m\x1b[2J\x1b[H", 11, NULL);
}
...
term_setattr(int attr)
{
	...
	str[strlen(str) - 1] = 'm';
	cterm_write(cterm, str, strlen(str), NULL);
}
...
#define MultW 2
	...
	switch ((char)codeStr[0]) {
		case 'a':
			...
			cterm_write(cterm, "-<Supply Room>  \xe9 ", -1, NULL);
			break;
		...
		case 'b':
			...
			term_setattr(LIGHTBLUE);
			cterm_write(cterm, "-<Chambers>  \xe9 ", -1, NULL);
			break;
		...
		case 'c':
			...
			term_setattr(LIGHTBLUE);
			cterm_write(cterm, "-<Specs>  \xe9 ", -1, NULL);
			break;
		...
		case 'd':
			...
			cterm_write(cterm, "Crystals in Savings : ", -1, NULL);
			getBlock(&codeStr, menuBlock, sizeof(menuBlock));
			strlcat(menuBlock, "\r\n", sizeof(menuBlock));
			cterm_write(cterm, menuBlock, -1, NULL);

			cterm_write(cterm, "Crystals on Loan    : ", -1, NULL);
			getBlock(&codeStr, menuBlock, sizeof(menuBlock));
			strlcat(menuBlock, "\r\n", sizeof(menuBlock));
			cterm_write(cterm, menuBlock, -1, NULL);
			...
			cterm_write(cterm, "You have ", -1, NULL);
			cterm_write(cterm, menuBlock, -1, NULL);
			cterm_write(cterm, " crystals onhand.\r\n\r\n", -1, NULL);
			term_setattr(LIGHTBLUE);
			cterm_write(cterm, "-<Bank>  \xe9 ", -1, NULL);
			break;
		...
		case 'e':
			...
			term_setattr(WHITE);
			getBlock(&codeStr, menuBlock, sizeof(menuBlock));
			cterm_write(cterm, "Games Left :[ ", -1, NULL);
			term_setattr(LIGHTCYAN);
			cterm_write(cterm, menuBlock, -1, NULL);
			cterm_write(cterm, "\r\n\r\n", -1, NULL);
			term_setattr(LIGHTGREEN);
			...
			term_setattr(LIGHTBLUE);
			cterm_write(cterm, "-<Games Room>  \xe9 ", -1, NULL);
			break;
		...
		case 'f':
			...
			cterm_write(cterm, "-[*]  Exit to Barracks\r\n\r\n", -1, NULL);
			term_setattr(LIGHTBLUE);
			cterm_write(cterm, "-<Sentry Post>  \xe9 ", -1, NULL);
			break;
		...
		case 'g':
			...
			term_setattr(WHITE);
			cterm_write(cterm, "Electronic-Mail\r\n", -1, NULL);
			...
			term_setattr(LIGHTBLUE);
			cterm_write(cterm, "-<E-Mail>  \xe9 ", -1, NULL);
			break;
		...
		case 'i':
			...
			term_setattr(LIGHTCYAN);
			cterm_write(cterm, "Medical Center\r\n", -1, NULL);
			term_setattr(CYAN);
			cterm_write(cterm, "~~~~~~~~~~~~~~\r\n", -1, NULL);
			term_setattr(LIGHTGREEN);

			cterm_write(cterm, "Radiation   :[ ", -1, NULL);
			getBlock(&codeStr, menuBlock, sizeof(menuBlock));
			zz = atoi(menuBlock);
			if (zz < 44)
				term_setattr(WHITE);
			...
			term_setattr(LIGHTGREEN);
			cterm_write(cterm, "Hit Points  :[ ", -1, NULL);
			getBlock(&codeStr, menuBlock, sizeof(menuBlock));
			zz = atoi(menuBlock);
			if (zz > 5)
				term_setattr(WHITE);
			...
			cterm_write(cterm, menuBlock, -1, NULL);
			getBlock(&codeStr, menuBlock, sizeof(menuBlock));
			cterm_write(cterm, " (", -1, NULL);
			cterm_write(cterm, menuBlock, -1, NULL);
			cterm_write(cterm, ")\r\n", -1, NULL);

			term_setattr(LIGHTGREEN);
			cterm_write(cterm, "Infectious  :[ ", -1, NULL);
			getBlock(&codeStr, menuBlock, sizeof(menuBlock));
			zz = atoi(menuBlock);
			if (zz < 0 || zz >= 11)
				break;
			...
			cterm_write(cterm, diseases[zz], -1, NULL);
			cterm_write(cterm, "\r\n\r\n", -1, NULL);
			term_setattr(CYAN);
			...
			cterm_write(cterm, "-[*]  Back to HQ\r\n\r\n", -1, NULL);
			term_setattr(LIGHTBLUE);
			cterm_write(cterm, "-<Medical Center>  \xe9 ", -1, NULL);
			break;
		...
		case 'j':
			...
			cterm_write(cterm, "-[*]  Back to HQ\r\n\r\n", -1, NULL);
			term_setattr(LIGHTBLUE);
			cterm_write(cterm, "-<Records>  \xe9 ", -1, NULL);
			break;
		...
		case 'k':
			...
			term_setattr(LIGHTGREEN);
			cterm_write(cterm, "Supply Armor\r\n", -1, NULL);
			term_setattr(GREEN);
			cterm_write(cterm, "~~~~~~~~~~~~\r\n", -1, NULL);
			term_setattr(WHITE);
			...
			if (zz < 0 || zz >= 13)
				break;
			cterm_write(cterm, armors[zz], -1, NULL);
			cterm_write(cterm, " / ", -1, NULL);
			getBlock(&codeStr, menuBlock, sizeof(menuBlock));
			cterm_write(cterm, menuBlock, -1, NULL);
			...
			term_setattr(LIGHTBLUE);
			cterm_write(cterm, "-<Supply Armor>  \xe9 ", -1, NULL);
			break;
		...
		case 'm':
			...
			if (codeStr[0] == '1') {
				term_setattr(LIGHTGREEN);
				cterm_write(cterm, "Supply Equipment\r\n", -1, NULL);
				term_setattr(GREEN);
				cterm_write(cterm, "~~~~~~~~~~~~~~~~\r\n", -1, NULL);
			}
			else {
				...
				cterm_write(cterm, "-[*]  Back to Supply Room\r\n\r\n", -1, NULL);
				term_setattr(LIGHTBLUE);
				cterm_write(cterm, "-<Supply Equip>  \xe9 ", -1, NULL);
			}
			break;
		...
		case 'o':
			...
			cterm_write(cterm, "~~~~~~~~~~~~\r\n", -1, NULL);
			term_setattr(WHITE);
			cterm_write(cterm, "Suit : ", -1, NULL);
			cterm_write(cterm, suits[zz], -1, NULL);
			...
			cterm_write(cterm, "-[*]  Back to Supply Room\r\n\r\n", -1, NULL);
			term_setattr(LIGHTBLUE);
			cterm_write(cterm, "-<Supply Suits>  \xe9 ", -1, NULL);
			break;
		...
		case 'q':
			...
			term_setattr(LIGHTGREEN);
			cterm_write(cterm, "Supply Weapons\r\n", -1, NULL);
			term_setattr(GREEN);
			cterm_write(cterm, "~~~~~~~~~~~~~~\r\n", -1, NULL);
			term_setattr(WHITE);
			...
			for (yy = 1; yy < 3; yy++) {
				...
				zz = atoi(menuBlock);
				if (zz >= 0 && zz < 27)
					cterm_write(cterm, weapons[zz], -1, NULL);
				cterm_write(cterm, " / ", -1, NULL);
				getBlock(&codeStr, menuBlock, sizeof(menuBlock));
				zz = atoi(menuBlock);
				if (zz >= 0 && zz < 6)
					cterm_write(cterm, ammos[zz], -1, NULL);
				cterm_write(cterm, " / ", -1, NULL);
				getBlock(&codeStr, menuBlock, sizeof(menuBlock));
				cterm_write(cterm, menuBlock, -1, NULL);
			...
			cterm_write(cterm, "-[*]  Back to Supply Room\r\n\r\n", -1, NULL);
			term_setattr(LIGHTBLUE);
			cterm_write(cterm, "-<Supply Weapons>  \xe9 ", -1, NULL);
			break;
		...
		case 's':
			...
			term_setattr(LIGHTGREEN);
			cterm_write(cterm, "Squadrons Menu\r\n", -1, NULL);
			term_setattr(GREEN);
			cterm_write(cterm, "~~~~~~~~~~~~~~\r\n", -1, NULL);
			term_setattr(LIGHTCYAN);
			...
			term_setattr(LIGHTBLUE);
			cterm_write(cterm, "-<Squadrons>  \xe9 ", -1, NULL);
			break;
		...
		case 't':
			...
			term_setattr(WHITE);
			cterm_write(cterm, "Sighting : ", -1, NULL);
			term_setattr(LIGHTMAGENTA);
			cterm_write(cterm, menuBlock, -1, NULL);
			term_setattr(LIGHTCYAN);
			...
			if (!zz) {
				term_setattr(LIGHTCYAN);
				cterm_write(cterm, "-[R]  ", -1, NULL);
				term_setattr(CYAN);
				cterm_write(cterm, "Run like hell!\r\n", -1, NULL);
			}

			term_setattr(LIGHTCYAN);
			cterm_write(cterm, "\r\n-[C]  ", -1, NULL);
			term_setattr(MAGENTA);
			cterm_write(cterm, "Check Status\r\n", -1, NULL);
			term_setattr(LIGHTCYAN);
			cterm_write(cterm, "-[V]  ", -1, NULL);
			term_setattr(MAGENTA);
			cterm_write(cterm, "View Opponent\r\n\r\n", -1, NULL);
			term_setattr(LIGHTCYAN);
			cterm_write(cterm, "-[M]  ", -1, NULL);
			term_setattr(LIGHTGRAY);
			cterm_write(cterm, "Toggle Combat Modes\r\n\r\n", -1, NULL);
			term_setattr(LIGHTBLUE);
			cterm_write(cterm, "-<Combat>  \xe9 ", -1, NULL);
			break;
		...
		case 'u':
			...
			for (zz = 0; zz < (10 + strlen(menuBlock)); zz++)
				cterm_write(cterm, "~", -1, NULL);
			cterm_write(cterm, "\r\n", -1, NULL);
			...
			cterm_write(cterm, "-[V]  View ", -1, NULL);
			cterm_write(cterm, tempBlock, -1, NULL);
			...
			term_setattr(LIGHTBLUE);
			cterm_write(cterm, "-<Camp>  \xe9 ", -1, NULL);
			break;
		...
		case 'v':
			...
			term_setattr(LIGHTGREEN);
			cterm_write(cterm, "Applications :[ ", -1, NULL);
			term_setattr(WHITE);
			getBlock(&codeStr, menuBlock, sizeof(menuBlock));
			...
			term_setattr(WHITE);
			cterm_write(cterm, "Also, you are ", -1, NULL);
			getBlock(&codeStr, menuBlock, sizeof(menuBlock));
			zz = atoi(menuBlock);
			switch (zz) {
				case 0:
				...
				case 4:
					term_setattr(LIGHTRED);
					cterm_write(cterm, "DYING ", -1, NULL);
					term_setattr(WHITE);
			...
			cterm_write(cterm, "-[*]  Exit\r\n\r\n", -1, NULL);
			term_setattr(LIGHTBLUE);
			cterm_write(cterm, "-<Medpacks>  \xe9 ", -1, NULL);
			break;
	}
...
checkStamp(int xx, int yy, char stampStr[]) // used w/ incomingCheck
{
	...
	term_setattr(LIGHTCYAN);
	cterm_write(cterm, stampStr, -1, NULL);
	term_setattr(CYAN);
	cterm_write(cterm, "\xe9", -1, NULL);
	return;
}
...
incomingCheckStatus(unsigned char *codeStr)
{
	...
	term_setattr(LIGHTCYAN);
	cterm_write(cterm, "Recruit   ", -1, NULL);
	term_setattr(CYAN);
	cterm_write(cterm, "\xe9", -1, NULL);
	term_setattr(who);
	term_gotoxy(34, 3);
	cterm_write(cterm, " \xb3", -1, NULL);
	term_gotoxy(1, 4);
	cterm_write(cterm,
...
{
	if (!miniTrik) {
		if ((s == 7) || ((s >= 9) && (s <= 11)) || ((s >= 26) && (s <= 28)) || ((s >= 31) && (s <= 33))
		    || (s == 38))
			return "??";
	}
...
incomingMapScanner(unsigned char *codeStr)
{
	...
	switch ((char)codeStr[0]) {
		case 'F':
			...
			cterm_write(cterm, "\xb3 ", -1, NULL);
			term_setattr(5);
			cterm_write(cterm, "\xd6\xc4", -1, NULL);
			term_setattr(13);
			cterm_write(cterm, "Infrared", -1, NULL);
			term_setattr(5);
			cterm_write(cterm, "\xc4\xb7", -1, NULL);
			term_setattr(13);
			cterm_write(cterm,
			...
			cterm_write(cterm, "\xb3 ", -1, NULL);
			term_setattr(5);
			cterm_write(cterm, "\xc7          \xb6   [         ]    [ ]  ", -1, NULL);
			term_setattr(13);
			cterm_write(cterm, "Items         Hit Points", -1, NULL);
			term_setattr(5);
			cterm_write(cterm, " [:            ", -1, NULL);
			term_setattr(1);
			cterm_write(cterm, "\xb3\r\n", -1, NULL);
			...
			cterm_write(cterm, "\xc7          \xb6                  [ ]  ", -1, NULL);
			term_setattr(13);
			cterm_write(cterm, "Campers       Radiation  ", -1, NULL);
			term_setattr(5);
			cterm_write(cterm, "[:            ", -1, NULL);
			term_setattr(1);
			cterm_write(cterm, "\xb3\r\n", -1, NULL);
			cterm_write(cterm, "\xb3 ", -1, NULL);
			term_setattr(5);
			cterm_write(cterm, "\xd3\xc4\xc4\xc4", -1, NULL);
			term_setattr(13);
			cterm_write(cterm, "scan", -1, NULL);
			term_setattr(5);
			cterm_write(cterm, "\xc4\xc4\xc4\xbd    ", -1, NULL);
			term_setattr(13);
			cterm_write(cterm, "Time :        ", -1, NULL);
			term_setattr(5);
			cterm_write(cterm, "[ ]  ", -1, NULL);
			term_setattr(13);
			cterm_write(cterm, "Bases         Condition  ", -1, NULL);
			term_setattr(5);
			cterm_write(cterm, "[:            ", -1, NULL);
			term_setattr(1);
			cterm_write(cterm, "\xb3\r\n", -1, NULL);
			...
			for (zz = 1; zz < 9; zz++) {
				switch (zz) {
					...
					case 8:
						...
						switch (yy) {
							case 0:
								cterm_write(cterm, "Not Hungry", -1, NULL);
								break;
							case 1:
								cterm_write(cterm, "Bit Hungry", -1, NULL);
								break;
							case 2:
								cterm_write(cterm, "Hungry    ", -1, NULL);
								break;
							case 3:
								term_setattr(12);
								cterm_write(cterm, "HUNGRY!   ", -1, NULL);
							...
							case 4:
								term_setattr(12 + 128);
								cterm_write(cterm, "STARVING!!", -1, NULL);
								break;
						}
						break;
				}
			...
			switch (zz) {
				...
				case 4:
					cterm_write(cterm,
					    ...
					    NULL);
					term_gotoxy(3, 11);
					cterm_write(cterm, "way through the bubbling slime.", -1, NULL);
					break;
				...
				case 9:
					cterm_write(cterm,
					    ...
					    NULL);
					term_gotoxy(3, 11);
					cterm_write(cterm, "ash and metallic scraps.", -1, NULL);
					break;
		...
		case 'P':
			...
			term_gotoxy(3, 10);
			term_setattr(11);
			cterm_write(cterm, "20 foot pit!", -1, NULL);
			break;
	}
...
incomingSoundVoc(unsigned char *codeStr)
{
	...
	switch (*codeStr) {
		case '1':
			cterm_play_fx_u8(cterm, ooii_snd_welcome, sizeof(ooii_snd_welcome));
			break;
		case '3':
			cterm_play_fx_u8(cterm, ooii_snd_countdn, sizeof(ooii_snd_countdn));

                /* Fallthrough */
		case '2':
			cterm_play_fx_u8(cterm, ooii_snd_explode, sizeof(ooii_snd_explode));
			break;
		case '4':
			cterm_play_fx_u8(cterm, ooii_snd_clone, sizeof(ooii_snd_clone));
			break;
		case '5':
			if (xp_random(2))
				cterm_play_fx_u8(cterm, ooii_snd_danger1, sizeof(ooii_snd_danger1));
			else
				cterm_play_fx_u8(cterm, ooii_snd_danger2, sizeof(ooii_snd_danger2));
			break;
		case '6':
			cterm_play_fx_u8(cterm, ooii_snd_steam, sizeof(ooii_snd_steam));
			break;
		case '7':
			cterm_play_fx_u8(cterm, ooii_snd_scream1, sizeof(ooii_snd_scream1));
			break;
		case '8':
			cterm_play_fx_u8(cterm, ooii_snd_watch, sizeof(ooii_snd_watch));
			break;
		case '9':
			cterm_play_fx_u8(cterm, ooii_snd_levelup, sizeof(ooii_snd_levelup));
			break;
		case 'A':
			cterm_play_fx_u8(cterm, ooii_snd_inflame, sizeof(ooii_snd_inflame));
			break;
		case 'B':
			switch (xp_random(3)) {
				case 0:
					cterm_play_fx_u8(cterm, ooii_snd_hit1, sizeof(ooii_snd_hit1));
					break;
				case 1:
					cterm_play_fx_u8(cterm, ooii_snd_hit2, sizeof(ooii_snd_hit2));
					break;
				case 2:
					cterm_play_fx_u8(cterm, ooii_snd_hit3, sizeof(ooii_snd_hit3));
					break;
			}
			break;
		case 'C':
			cterm_play_fx_u8(cterm, ooii_snd_timeisup, sizeof(ooii_snd_timeisup));
			break;
		case 'D':
			cterm_play_fx_u8(cterm, ooii_snd_healing, sizeof(ooii_snd_healing));
			break;
		case 'E':
			cterm_play_fx_u8(cterm, ooii_snd_lrange2, sizeof(ooii_snd_lrange2));
			break;
		case 'F':
			cterm_play_fx_u8(cterm, ooii_snd_cackle, sizeof(ooii_snd_cackle));
			break;
		case 'G':
			cterm_play_fx_u8(cterm, ooii_snd_teleport, sizeof(ooii_snd_teleport));
			break;
		case 'H':
			cterm_play_fx_u8(cterm, ooii_snd_genetics, sizeof(ooii_snd_genetics));
			break;
		case 'I':
			cterm_play_fx_u8(cterm, ooii_snd_remote, sizeof(ooii_snd_remote));
			break;
		case 'J':
			cterm_play_fx_u8(cterm, ooii_snd_afbdoor, sizeof(ooii_snd_afbdoor));
			break;
		case 'K':
			cterm_play_fx_u8(cterm, ooii_snd_alarm, sizeof(ooii_snd_alarm));
			break;
		case 'L':
			cterm_play_fx_u8(cterm, ooii_snd_reverse, sizeof(ooii_snd_reverse));
			break;
		case 'M':
			cterm_play_fx_u8(cterm, ooii_snd_aerial, sizeof(ooii_snd_aerial));
			break;
		case 'N':
			cterm_play_fx_u8(cterm, ooii_snd_phaser, sizeof(ooii_snd_phaser));
			break;
		case 'O':
			switch (xp_random(3)) {
				case 0:
					cterm_play_fx_u8(cterm, ooii_snd_miss1, sizeof(ooii_snd_miss1));
					break;
				case 1:
					cterm_play_fx_u8(cterm, ooii_snd_miss2, sizeof(ooii_snd_miss2));
					break;
				case 2:
					cterm_play_fx_u8(cterm, ooii_snd_miss3, sizeof(ooii_snd_miss3));
					break;
			}
			break;
		case 'P':
			if (xp_random(2))
				cterm_play_fx_u8(cterm, ooii_snd_music1, sizeof(ooii_snd_music1));
			else
				cterm_play_fx_u8(cterm, ooii_snd_music2, sizeof(ooii_snd_music2));
			break;
		case 'Q':
			cterm_play_fx_u8(cterm, ooii_snd_device, sizeof(ooii_snd_device));
			break;
		case 'R':
			cterm_play_fx_u8(cterm, ooii_snd_death, sizeof(ooii_snd_death));
			break;
		case 'S':
			cterm_play_fx_u8(cterm, ooii_snd_good, sizeof(ooii_snd_good));
			break;
		case 'T':
			cterm_play_fx_u8(cterm, ooii_snd_yahoo, sizeof(ooii_snd_yahoo));
			break;
		case 'U':
			cterm_play_fx_u8(cterm, ooii_snd_scream2, sizeof(ooii_snd_scream2));
			break;
		case 'V':
			cterm_play_fx_u8(cterm, ooii_snd_wap, sizeof(ooii_snd_wap));
			break;
		case 'W':
			cterm_play_fx_u8(cterm, ooii_snd_zip, sizeof(ooii_snd_zip));
			break;
		case 'X':
			cterm_play_fx_u8(cterm, ooii_snd_lrange3, sizeof(ooii_snd_lrange3));
			break;
		case 'Y':
			cterm_play_fx_u8(cterm, ooii_snd_snip, sizeof(ooii_snd_snip));
			break;
		case 'Z':
			cterm_play_fx_u8(cterm, ooii_snd_pow, sizeof(ooii_snd_pow));
			break;
		default:
                        /*
                         * LRANGE1 is unused
                         * cterm_play_fx_u8(cterm, ooii_snd_lrange1, sizeof(ooii_snd_lrange1));
                         */
			break;
	}
	return codeStr - origCodeStr;
