...
row using the same wrapping rules as Up and Down; clicks on the
scrollbar column step or jump proportionally.
...
focus traversal.  A left click positions the cursor and a middle click pastes
there.  Drag events fall through to the App's screen-selection handler.
