...
The shipped controller defines the main-menu interaction contract.  Tab,
Backtab, Left, and Right move focus between the
...
Ctrl-D, and Alt-B invoke their documented commands.  The comment row is
clickable for direct editing.  An override may present the model differently,
but it is responsible for preserving this user-visible behavior.
