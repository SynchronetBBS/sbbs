...
the titles `File Locations` and `Build Options`; their Markdown content defines
the label emphasis, indentation, dimensions, and section layout rendered by
the shared Help viewer.
